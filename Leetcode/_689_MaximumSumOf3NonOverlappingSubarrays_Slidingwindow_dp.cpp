...
// https://leetcode.com/problems/maximum-sum-of-3-non-overlapping-subarrays/solutions/6179921/maximum-sum-of-3-non-overlapping-subarrays
...
int main(){
    ...
    int k = 2;
    vector<int> res = s.maxSumOfThreeSubarrays(nums, k);
